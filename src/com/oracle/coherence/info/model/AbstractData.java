...
public abstract class AbstractData implements Data, DataRetriever, Serializable {
	...
	public void setColumn(int nColumn, Object oValue) {
		if (nColumn > nColumnCount - 1) {
			throw new IllegalArgumentException("Invalid column index nColumn=" + nColumn + " , nColumnCount=" + nColumnCount + ", class="
	 ...
	 *
	 * @param sValue
	 *            the String value which may actually have decimal placed or
	 *            even be in exponential notation.
	 *
	...
	public String toString() {
		...
		for (int i = 0; i < nColumnCount; i++) {
			sb.append(", Column ").append(i).append("=").append(oColumnValues[i] == null ? "null" : oColumnValues[i].toString());
		}
