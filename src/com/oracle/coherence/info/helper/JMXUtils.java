...
public class JMXUtils {
	 ...
	 *
	 * @param server
	 *            the {@link MBeanServerConnection} to query
	 * @param sQuery
	 *            the query to run
	 * @param aFields
	 *            the array of attributes to retrieve
	 *
	...
	public static Set<Object[]> runJMXQuery(MBeanServerConnection server, String sQuery, JMXField[] aFields) {
		...
		try {
			...
			throw new RuntimeException("Unable to run query " + sQuery + " for fields " + aFields + " : " + e.getMessage());
		}
